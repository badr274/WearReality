    ...
    <Container className="mt-4" style={{ padding: "30px" }}>
      ...
      <Row className="mb-4 g-4">
        <Col md={3}>
          <Card>
            <Card.Body>
              <h6 style={{ color: "rgb(101, 18, 20)" }}>Total Products</h6>
              <h4>124</h4>
            </Card.Body>
          </Card>
        </Col>
        <Col md={3}>
          <Card>
            <Card.Body>
              <h6 style={{ color: "rgb(101, 18, 20)" }}>Total Customers</h6>
              <h4>89</h4>
            </Card.Body>
          </Card>
        </Col>
        <Col md={3}>
          <Card>
            <Card.Body>
              <h6 style={{ color: "rgb(101, 18, 20)" }}>Products In Stock</h6>
              <h4>4500 pcs</h4>
            </Card.Body>
          </Card>
        </Col>
        <Col md={3}>
          <Card>
            <Card.Body>
              <h6 style={{ color: "rgb(101, 18, 20)" }}>Inactive Products</h6>
              <h4>9</h4>
            </Card.Body>
          </Card>
        </Col>
      ...
      <Row className="mb-4">
        <Col>
          <Card className="shadow-sm">
            <Card.Body>
              <h5 className="mb-3" style={{ color: "rgb(101, 18, 20)" }}>
                Category Progress
              </h5>
              <p>Women's Fashion</p>
            ...
            <Card.Body>
              ...
              <ul className="list-group">
                <li className="list-group-item">
                  [12:03 PM] Added new product "Woman Karma"
                </li>
                <li className="list-group-item">
                  [11:50 AM] Updated stock for "Woman Shawl"
                </li>
                <li className="list-group-item">
                  [10:22 AM] Deleted product "Old Jacket"
                </li>
              </ul>
            </Card.Body>
          </Card>
